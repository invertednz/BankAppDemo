...
#if [[ $teststorun == "high" ]] ; then mvn -Dtest=OnlineAccountTests#Area1Test1,OnlineAccountTests#Area1Test2,OnlineAccountTests#Area1Test3,OnlineAccountTests#Area1Test4,OnlineAccountTests#Area1Test5 test ; . ./PushResultsToAppsurify.sh  ; fi
if [[ $teststorun == "high" ]] ; then mvn -Dtest=OnlineAccountTests test ; . ./PushResultsToAppsurify.sh  ; fi
index=0
